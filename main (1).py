...
class BikeRental:
    ...
    def rentBikeOnHourlyBasis(self, n):
        ...
        # rent the bikes
            ...
            print("You will be charged 400rs for each hour per bike.")
    ...
    def rentBikeOnDailyBasis(self, n):
        ...
        if n <= 0:
            ...
            print("You will be charged 1500rs for each day per bike.")
            print("We hope that you enjoy our service.")
            self.stock -= n
            return now
    ...
    def rentBikeOnWeeklyBasis(self, n):
        ...
        if n <= 0:
            ...
            print("You will be charged 4000rs for each week per bike.")
            print("We hope that you enjoy our service.")
            self.stock -= n
            return now
    ...
    def returnBike(self, request):
        ...
        if rentalTime and rentalBasis and numOfBikes:
            ...
            if rentalBasis == 1:
                bill = round(rentalPeriod.seconds / 3600) * 400 * numOfBikes

            # daily bill calculation
            elif rentalBasis == 2:
                bill = round(rentalPeriod.days) * 1500 * numOfBikes

            # weekly bill calculation
            elif rentalBasis == 3:
                bill = round(rentalPeriod.days / 7) * 5000 * numOfBikes
            print(bill)
